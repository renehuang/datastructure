 ...
 */
void merge_sort(char a[], int n, int order)
{	
	int current_order=order-ceil(log(n)/log(2));
...
int main()
{
    ...
    int order=ceil(log(n)/log(2));
    merge_sort(a, n, order);
